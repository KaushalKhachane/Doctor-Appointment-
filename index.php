...
<html lang="en">
    ...
    <body>
        ...
        <nav class="navbar navbar-default navbar-fixed-top" role="navigation">
            <div class="container-fluid">
                ...
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="index.php">Welcome To HealthCare Appointment System</a>
                </div>
        ...
        <div class="copyright-bar bg-black">
            <div class="container">
                <p class="pull-left small">©Appointment Healthcare <a href ="">By Tanavi and Kaushal </a></p>
